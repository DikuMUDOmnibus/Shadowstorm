...
/* pet recycling */
#define PD PET_DATA
PD      *new_pet args( (void) );
void    free_pet args( (PET_DATA *pEt) );
#undef PD    


/* house recycling */
#define HD HOUSE_DATA
HD      *new_house args( (void) );
void    free_house args( (HOUSE_DATA *hOuse) );
#undef HD


/* mail recycling */
#define MD MAIL_DATA
MD      *new_mail args( (void) );
void    free_mail args( (MAIL_DATA *mAIL) );
#undef MD
