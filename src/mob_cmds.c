...
void do_mpgtransfer( CHAR_DATA *ch, char *argument )
{
    ...
    if ( (who = prog_char_room( ch, NULL, arg1 )) == NULL )
	return;
...
void do_mpcast( CHAR_DATA *ch, char *argument )
{
    ...
    vch = prog_char_room( ch, NULL, target );
...
void do_opechoaround( OBJ_DATA *obj, char *argument )
{
    ...
    if ( ( victim=prog_char_room( NULL, obj->in_room?obj->in_room:obj->carried_by->in_room, arg ) ) == NULL )
	return;
...
void do_opoload( OBJ_DATA *obj, char *argument )
{
    ...
    nobj->carried_by = obj->carried_by;
...
void do_opgtransfer( OBJ_DATA *obj, char *argument )
{
    ...
    if ( (who = prog_char_room( NULL, (obj->in_room)?obj->in_room:obj->carried_by->in_room, arg1 )) == NULL )
	return;
...
void do_opdamage( OBJ_DATA *obj, char *argument )
{
    ...
    if( !str_cmp( target, "all" ) )
	fAll = TRUE;
    else if( ( victim = prog_char_room( NULL, obj->in_room?obj->in_room:obj->carried_by->in_room, target ) ) == NULL )
	return;
...
void do_opcall( OBJ_DATA *obj, char *argument )
{
    ...
    argument = one_argument( argument, arg );
    if ( arg[0] != '\0' )
        vch = prog_char_room( NULL, obj->in_room?obj->in_room:obj->carried_by->in_room, arg );
    argument = one_argument( argument, arg );
    if ( arg[0] != '\0' )
...
void do_opattrib( OBJ_DATA *obj, char *argument )
{
    ...
    else if ( ( ch = prog_char_room( NULL, obj->in_room ? obj->in_room : obj->carried_by->in_room, target ) ) == NULL )
	return;
...
void do_rpechoaround( ROOM_INDEX_DATA *room, char *argument )
{
    ...
    if ( ( victim=prog_char_room( NULL, room, arg ) ) == NULL )
	return;
...
void do_rpgtransfer( ROOM_INDEX_DATA *room, char *argument )
{
    ...
    if ( (who = prog_char_room( NULL, room, arg1 )) == NULL )
	return;
...
void do_rpdamage( ROOM_INDEX_DATA *room, char *argument )
{
    ...
    if( !str_cmp( target, "all" ) )
	fAll = TRUE;
    else if( ( victim = prog_char_room( NULL, room, target ) ) == NULL )
	return;
...
void do_rpcall( ROOM_INDEX_DATA *room, char *argument )
{
    ...
    argument = one_argument( argument, arg );
    if ( arg[0] != '\0' )
        vch = prog_char_room( NULL, room, arg );
    argument = one_argument( argument, arg );
    if ( arg[0] != '\0' )
